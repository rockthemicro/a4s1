...
public class Test {
    ...
    public static void main(String[] args) throws IOException {
        CharStream input = CharStreams.fromFileName("program2.txt");
        ...
        */
        ...
        HelloParserBaseListener listener = new HelloParserBaseListener() {
            @Override
        ...
        HelloParserBaseVisitor visitor = new HelloParserBaseVisitor<List<String>>() {
            @Override
